...
class compressor():
	def cssmin( self, css, linebreakpos ):
		...
		# pre-compile regexp's so they only have to be compiled one as they are used in loops or functions
